    ...
    public class DataModel {
        public void CreateDB () {
            ...
            using (var context = new ReligionDatabaseContext ()) {
                ...
                context.Participants.Add (par1);
                context.Participants.Add (par2);
                context.Participants.Add (par3);
                context.Participants.Add (par4);
                context.Participants.Add (par5);
                context.Participants.Add (par6);
                ...
                context.Participants.Add (par7);
                context.Participants.Add (par8);
                context.Participants.Add (par9);
                context.Participants.Add (par10);
                context.Participants.Add (par11);
                context.Participants.Add (par12);
                ...
                context.Participants.Add (par13);
                context.Participants.Add (par14);
                context.Participants.Add (par15);
                context.Participants.Add (par16);
                context.Participants.Add (par17);
                context.Participants.Add (par18);
                ...
                context.Participants.Add (par19);
                context.Participants.Add (par20);
                context.Participants.Add (par21);
                context.Participants.Add (par22);
                context.Participants.Add (par23);
                context.Participants.Add (par24);
                ...
                context.Participants.Add (par25);
                context.Participants.Add (par26);
                context.Participants.Add (par27);
                context.Participants.Add (par28);
                context.Participants.Add (par29);
                context.Participants.Add (par30);
